...
const Footer = ({ theme }) => {
  return (
    ...
    >
      ...
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        ...
        >
          ...
          <p className="text-sm mt-2 mb-6">
            {" "}
            The latest news, artciles and resoucres sent to your in box weekly.
          </p>
          <div className="flex gap-2 text-sm">
            ...
            />
            <button className="bg-gradient-to-r from-[#3B82F6] to-[#2563EB] text-white rounded px-6">
              Subscribe
            </button>
          </div>
        </motion.div>
      ...
      >
        <p>
          Copyright 2025 &copy; PS and Sons Construction LLC - All Right
          Reserved.
        </p>
